        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-dark"><?= number_format($userStats['total_users'] ?? 0) ?></p>
                </div>
        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-dark"><?= number_format($userStats['active_users'] ?? 0) ?></p>
                </div>
        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-dark"><?= number_format($userStats['inactive_users'] ?? 0) ?></p>
                </div>
        ...
        <div class="dashboard-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-text-dark"><?= number_format($userStats['unique_roles'] ?? 0) ?></p>
                </div>
                ...
                <div class="p-4 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select id="departmentFilter" class="w-full h-12 pl-4 pr-4 bg-white rounded-xl border border-[#D1D1E9] text-text-dark text-sm focus:outline-none focus:border-secondary">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" id="dateFrom" class="w-full h-12 pl-4 pr-4 bg-white rounded-xl border border-[#D1D1E9] text-text-dark text-sm focus:outline-none focus:border-secondary">
                        </div>
                        <div>
                            <label class="block text-text-dark/70 text-sm mb-2">Date To</label>
                            <input type="date" id="dateTo" class="w-full h-12 pl-4 pr-4 bg-white rounded-xl border border-[#D1D1E9] text-text-dark text-sm focus:outline-none focus:border-secondary">
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        <table id="usersTable" class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-[#E3DAEE]">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-text-dark/80 uppercase tracking-wider">
                                        ID
                                    </th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-text-dark/80 uppercase tracking-wider">
                                        Name
