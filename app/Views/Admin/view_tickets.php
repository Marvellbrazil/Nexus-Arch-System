    ...
    <div class="mb-8">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-[15.45px] font-light text-text-dark">Track and manage all incoming support tickets and projects</p>
            </div>
            <button id="viewProjectsBtn" class="h-12 px-6 bg-secondary text-white rounded-lg hover:bg-[#665C9E] transition-colors font-medium flex items-center gap-2">
    ...
    <div class="dashboard-card mb-6">
        ...
        <div class="p-6">
            ...
            <div class="flex flex-wrap gap-4 items-center">
                <!-- Priority Filter -->
                <select id="priorityFilter" class="h-10 pl-4 pr-4 bg-white rounded-lg border border-[#D1D1E9] text-text-dark text-sm focus:outline-none focus:border-secondary">
                ...
                <!-- Department Filter -->
                <select id="departmentFilter" class="h-10 pl-4 pr-4 bg-white rounded-lg border border-[#D1D1E9] text-text-dark text-sm focus:outline-none focus:border-secondary">
                ...
                <!-- Status Filter -->
                <select id="statusFilter" class="h-10 pl-4 pr-4 bg-white rounded-lg border border-[#D1D1E9] text-text-dark text-sm focus:outline-none focus:border-secondary">
                ...
                <!-- Reset Button -->
                <button id="resetFilters" class="h-10 px-4 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium">
                    Reset Filters
                </button>
            </div>
        </div>
            ...
            <div class="flex justify-between items-center px-6">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div id="pageNumbers" class="flex items-center gap-1">
                        <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-secondary text-white">1</button>
                        <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 hover:bg-secondary/20 transition-colors">2</button>
                        <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 hover:bg-secondary/20 transition-colors">3</button>
                        <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 hover:bg-secondary/20 transition-colors">4</button>
                    </div>
                    <button id="nextPage" class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 hover:bg-secondary/20 transition-colors">
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-[1000] p-4">
        <div class="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Actions -->
                        <div class="space-y-2">
                            <button class="w-full py-2 bg-secondary text-white rounded-lg hover:bg-[#665C9E] transition-colors text-sm font-medium">
                                <i class="fas fa-edit mr-2"></i>Edit Ticket
                            </button>
                            <button class="w-full py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors text-sm font-medium">
                                <i class="fas fa-comment mr-2"></i>Add Comment
                            </button>
                            <button class="w-full py-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors text-sm font-medium">
                                <i class="fas fa-check mr-2"></i>Mark as Resolved
                            </button>
                            <button class="w-full py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors text-sm font-medium">
            ...
            <div class="p-6 border-t border-gray-200">
                <button class="close-modal px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
                    Close
                </button>
            </div>
        </div>
...
<style>
    ...
    .activity-dot.assigned { background: #10B981; }
    .activity-dot.updated { background: #F59E0B; }
    .activity-dot.resolved { background: #8B5CF6; }
    ...
    @media (max-width: 1024px) {
        ...
        .ticket-row > div:nth-child(1) { grid-column: span 1; }
        .ticket-row > div:nth-child(2) { grid-column: span 3; }
        .ticket-row > div:nth-child(3) { grid-column: span 1; }
        .ticket-row > div:nth-child(4) { grid-column: span 1; }
        .ticket-row > div:nth-child(5) { grid-column: span 1; }
        .ticket-row > div:nth-child(6) { grid-column: span 1; }
        .ticket-row > div:nth-child(7) { grid-column: span 1; }
    }
