...
<div id="userModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-[1000] p-4 hidden">
    <div class="bg-white rounded-2xl w-full max-w-md animate-slideInUp">
        ...
        <form id="userForm" class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="isActive" name="is_active" class="h-4 w-4 text-secondary focus:ring-secondary border-gray-300 rounded">
        ...
        <div class="p-6 border-t border-gray-200 flex gap-3">
            ...
            <button id="saveUser" class="flex-1 py-3 bg-secondary text-white rounded-lg hover:bg-[#817CB2] transition-colors">
                Save User
            </button>
        </div>
    </div>
