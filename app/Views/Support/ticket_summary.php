...
<div class="mt-16 md:mt-[77px] p-4 md:p-6 relative z-10">
    ...
    <div class="mb-6 md:mb-8">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
            ...
            <a href="<?= base_url('support/incoming') ?>" class="hover:text-secondary transition-colors">Incoming Tickets</a>
            <i class="fas fa-chevron-right text-xs"></i>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-5 border border-gray-200">
                            <div class="text-gray-700 leading-relaxed space-y-4">
                                <p>Hi Nexus Team,</p>
                                <p>I'm having an issue logging in to <?= $ticket['project_name'] ?? 'Project Alpha' ?>. Each time I enter my email and password, the system displays an "Incorrect credentials" error message, even though I'm confident the credentials are correct.</p>
                                <p>This issue started recently and persists despite trying basic troubleshooting steps such as:</p>
                                ...
                                <p>As a result, I'm unable to continue my work and would appreciate your assistance in resolving this issue as soon as possible.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-gray-700"><?= $ticket['customer_email'] ?? 'john.smith@gmail.com' ?></span>
                        </div>
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-medium"><?= date('M d, Y', strtotime($ticket['created_at'] ?? 'now')) ?></span>
                        </div>
                        
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Last Updated</span>
                            <span class="font-medium"><?= date('M d, Y h:i A', strtotime($ticket['updated_at'] ?? 'now')) ?></span>
                        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-gray-600">Forward this ticket to the appropriate department or return to incoming tickets</p>
            </div>
