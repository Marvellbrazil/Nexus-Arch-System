...
<div class="mt-4 md:mt-[77px] p-4 md:p-[30px] relative z-10">
    ...
    <!-- Section Title -->
    <div class="mb-4">
        <h2 class="text-lg md:text-[20px] font-medium text-text-dark">All Notifications</h2>
    </div>
    ...
    <div class="bg-gradient-to-r from-[#3D3C5E] to-[#48466B] rounded-2xl shadow-sm border border-[#AEA3CA] overflow-hidden mb-8">
        ...
        <div class="p-4 md:p-6 space-y-3 md:space-y-4 max-h-[500px] overflow-y-auto custom-scrollbar">
            <!-- Notification 1 -->
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="urgent" data-type="assignment">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <h3 class="text-base md:text-lg font-bold text-white">New ticket assigned to you</h3>
                            <span class="text-xs md:text-sm text-white/60">5 minutes ago</span>
                        </div>
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Ticket #2341 – Database Connection Error</p>
            ...
            <!-- Notification 2 -->
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="high" data-type="message">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <h3 class="text-base md:text-lg font-bold text-white">Customer replied to your ticket</h3>
                            <span class="text-xs md:text-sm text-white/60">30 minutes ago</span>
                        </div>
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Ticket #2338 – UI broken on mobile</p>
                        <div class="flex items-center gap-2">
            ...
            <!-- Notification 3 -->
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="medium" data-type="message">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <h3 class="text-base md:text-lg font-bold text-white">Customer sent a follow-up message</h3>
                            <span class="text-xs md:text-sm text-white/60">2 hours ago</span>
                        </div>
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Ticket #2342 – Email notification not sent</p>
                        <div class="flex items-center gap-2">
            ...
            <!-- Notification 4 -->
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="low" data-type="resolved">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <h3 class="text-base md:text-lg font-bold text-white">Ticket closed successfully</h3>
                            <span class="text-xs md:text-sm text-white/60">Today, 09:15</span>
                        </div>
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Ticket #2328 – Update profile picture issue</p>
                        <div class="flex items-center gap-2">
            ...
            <!-- Notification 5 -->
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="medium" data-type="reminder">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <h3 class="text-base md:text-lg font-bold text-white">SLA reminder: ticket needs attention</h3>
                            <span class="text-xs md:text-sm text-white/60">Today, 08:40</span>
                        </div>
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Ticket #2335 – Slow page load</p>
                        <div class="flex items-center gap-2">
                            <div class="priority-badge px-3 py-1 bg-[#FED7AA] rounded-lg">
                                <span class="text-xs font-bold text-orange-800">Medium</span>
                            </div>
        ...
        <div id="emptyState" class="hidden p-8 md:p-12 text-center">
            ...
            <h3 class="text-lg md:text-xl font-semibold text-white mb-2">There are no other notifications yet</h3>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (markAllReadBtn) {
            markAllReadBtn.addEventListener('click', function(e) {
                ...
                // Revert after form submission simulation
                setTimeout(() => {
        ...
        document.querySelectorAll('.notification-item').forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                if (indicator) {
                    ...
                    const unreadElement = document.querySelector('.text-3xl.font-bold.text-gray-800');
                    if (unreadElement) {
                        const currentUnread = parseInt(unreadElement.textContent || '3');
                        if (currentUnread > 0) {
                    ...
                    <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors animate-slide-in" data-priority="${notif.priorityValue}" data-type="${notif.type}">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div class="flex flex-col items-end gap-3">
                                <div class="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center ${notif.unread ? 'unread-indicator' : ''}">
