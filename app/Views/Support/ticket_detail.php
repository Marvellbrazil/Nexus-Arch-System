        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Mark as Resolved -->
                    <button id="markResolvedBtn" class="w-full px-4 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium flex items-center justify-center gap-2">
