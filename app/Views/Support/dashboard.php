...
<div class="mt-4 md:mt-[77px] p-4 md:p-[30px] relative z-10">
    ...
    <div class="mb-6 md:mb-[25px] relative">
        <div class="flex flex-col">
            <h1 class="text-2xl md:text-[35px] font-semibold mb-1 md:mb-[5px] text-text-dark">Support Agent's Dashboard
            </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-[20px] mb-6 md:mb-[30px]">
        ...
        <div
            class="md:col-span-2 lg:col-span-9 bg-gradient-to-r from-[#3C3B5D] to-[#48466B] rounded-xl p-4 md:p-6 shadow-sm">
            <div class="flex items-center justify-between mb-4 md:mb-6">
                <h3 class="text-white text-lg md:text-[20px] font-semibold">Recent Incoming Tickets</h3>
                <a href="<?= base_url('support/incoming') ?>"
                    class="text-white/80 text-sm md:text-[14px] hover:text-white transition-colors">
                    View All
                </a>
            </div>
            ...
            <div class="space-y-3">
                <?php if (!empty($recent_tickets)): ?>
                    <?php foreach ($recent_tickets as $ticket): ?>
                        <div
                            class="bg-white/10 rounded-lg p-3 md:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            <div class="flex-1">
        ...
        <div
            class="md:col-span-2 lg:col-span-4 bg-gradient-to-r from-secondary to-[#8A84C6] rounded-xl p-4 md:p-[25px]">
            <h3 class="text-white text-base md:text-[18px] font-semibold text-center mb-4 md:mb-6">Quick Ticket Search
            </h3>
                        ...
                        <div class="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 mb-1">
                                    <p
                                        class="text-text-dark text-sm md:text-[14px] font-medium <?= $isUnread ? 'font-semibold' : '' ?> truncate">
