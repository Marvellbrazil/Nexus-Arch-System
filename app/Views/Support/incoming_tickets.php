    ...
    <div class="mb-6 md:mb-[25px] relative">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex-1">
                ...
                <p class="text-sm md:text-[15px] font-light text-[#666]">Review and forward tickets to appropriate
                    departments</p>
            </div>
                ...
                <tbody id="ticketsTable" class="divide-y divide-gray-200">
                    <?php if (!empty($tickets)): ?>
                        <?php foreach ($tickets as $ticket): ?>
                            ...
                            ?>
                            <tr class="bg-white hover-row transition-colors" data-id="<?= $ticket['ticket_id'] ?>"
                                data-subject="<?= htmlspecialchars($ticket['subject']) ?>"
                                data-customer="<?= htmlspecialchars($ticket['customer_name']) ?>"
                                data-priority="<?= $ticket['priority_name'] ?>" data-priority-value="<?= $priorityValue ?>"
                                ...
                                <td class="py-3 px-3 md:py-4 md:px-6">
                                    <div>
                                        <p class="font-medium text-gray-800 text-sm truncate max-w-[150px] md:max-w-none"
                                            title="<?= htmlspecialchars($ticket['subject']) ?>">
                                ...
                                <td class="py-3 px-3 md:py-4 md:px-6 hidden md:table-cell">
                                    <div class="flex items-center gap-2">
                                        <div
                                            class="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-800 text-xs font-bold">
                                            <?= $initials ?>
                                        </div>
                                        <span
                                            class="text-gray-700 text-sm"><?= htmlspecialchars($ticket['customer_name']) ?></span>
                                    </div>
                                </td>
                                <td class="py-3 px-3 md:py-4 md:px-6">
                                    <span
                                        class="px-2 py-1 text-xs rounded-full <?= $priorityColor ?> font-medium whitespace-nowrap">
        ...
        <div class="p-4 md:p-6 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="text-gray-600 text-xs md:text-sm">
                    Showing <span id="showingCount"><?= count($tickets) ?></span> of <span
                        id="totalCount"><?= $stats['total_incoming'] ?? 0 ?></span> entries
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
            ...
            <p class="text-gray-600 text-sm md:text-base mb-4 md:mb-6">
                As a support agent, your role is to review incoming tickets and forward them to the appropriate
