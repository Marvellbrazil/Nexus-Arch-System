        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex-1">
                <div class="flex items-center gap-3 md:gap-4 mb-2">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-[32px] font-semibold text-text-dark"><?= $project['project_name'] ?></h1>
        ...
        <div class="bg-white rounded-xl p-3 md:p-5 shadow-sm border border-gray-200">
            <div class="flex items-center gap-2 md:gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-bold text-gray-800"><?= $project['in_progress_tickets'] ?? 0 ?></p>
                </div>
            </div>
        </div>
                    ...
                    <table class="w-full min-w-max">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="py-3 px-3 md:py-4 md:px-6 text-left text-xs md:text-sm font-semibold text-gray-700 hidden md:table-cell">
                                    Priority
                                </th>
                                <th class="py-3 px-3 md:py-4 md:px-6 text-left text-xs md:text-sm font-semibold text-gray-700">
                                    Status
                                ...
                                <tr>
                                    <td colspan="5" class="py-8 px-4 md:px-6 text-center text-gray-500">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-xs md:text-sm text-gray-500">Create your first ticket for this project</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php else: ?>
        ...
        <div class="space-y-4 md:space-y-6">
            ...
            <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
                ...
                <div class="space-y-3 md:space-y-4">
                    <div class="flex items-start gap-2 md:gap-3">
                        <div class="w-6 h-6 md:w-8 md:h-8 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="flex items-start gap-2 md:gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 text-sm md:text-base font-medium"><?= $project['project_code'] ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
                ...
                <div class="space-y-3 md:space-y-4">
                    ...
                    <div class="flex items-center gap-2 md:gap-3 p-2 md:p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        <div class="w-8 h-8 md:w-10 md:h-10 bg-secondary rounded-full flex items-center justify-center text-white text-sm md:text-base font-bold">
                            <?= substr($member['full_name'], 0, 1) ?>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-800 text-sm md:text-base font-medium truncate"><?= $member['full_name'] ?></p>
            ...
            <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
                ...
                <div class="space-y-3 md:space-y-4">
                    ...
                    <div class="flex items-start gap-2 md:gap-3 p-2 md:p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-800 text-xs md:text-sm font-medium truncate"><?= $activity['full_name'] ?> commented</p>
