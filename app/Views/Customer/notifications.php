    ...
    <div class="mb-6 md:mb-8">
        <div class="flex flex-col md:flex-row gap-4 md:gap-6">
            ...
            <div class="flex gap-3">
                <!-- Priority Dropdown -->
                <div class="relative">
                    <button class="h-12 md:h-14 px-4 md:px-6 bg-white border border-[#D1D1E9] rounded-xl text-text-dark text-sm md:text-base font-medium flex items-center gap-2 hover:bg-gray-50 transition-colors">
                        <span>Choose Priority</span>
                        <i class="fas fa-chevron-down text-xs"></i>
                    </button>
                    
                    <!-- Dropdown Menu -->
                    <div class="absolute top-full right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 z-50 hidden">
                        <div class="py-2">
                            <button class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
