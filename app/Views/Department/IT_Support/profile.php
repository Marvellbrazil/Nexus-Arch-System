            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Linux
                            Administration</span>
                        <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">Docker &
                            Kubernetes</span>
                        ...
                        <span class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">Database
                            Management</span>
                        <span class="px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm">Monitoring
                            Tools</span>
                        <span class="px-3 py-1 bg-pink-100 text-pink-800 rounded-full text-sm">Scripting
                            (Bash/Python)</span>
