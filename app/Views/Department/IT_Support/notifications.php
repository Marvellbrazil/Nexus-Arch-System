...
<div class="mt-4 md:mt-[77px] p-4 md:p-[30px] relative z-10">
    ...
    <div class="mb-6 md:mb-[25px] relative">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <form action="<?= base_url('department/it-support/notifications/mark_read') ?>" method="POST" class="inline">
                    <?= csrf_field() ?>
                    <button type="submit" class="px-4 py-2 bg-white text-secondary border border-secondary rounded-lg hover:bg-secondary/5 transition-all text-sm font-medium flex items-center gap-2">
        ...
        <div class="flex flex-col md:flex-row gap-4 md:gap-6">
            ...
            <div class="flex-1 relative">
                <div class="relative">
                    ...
                    <input type="text" 
                           placeholder="Search IT Support notifications..." 
                           id="searchInput"
            ...
            <div class="flex gap-3">
                ...
                <div class="flex gap-2">
                    <button data-filter="all" class="h-12 md:h-[50px] px-4 md:px-6 bg-secondary text-white border border-secondary rounded-xl text-sm md:text-[14px] font-medium hover:bg-[#817CB2] transition-colors">
                        All
                    </button>
                    <button data-filter="server" class="h-12 md:h-[50px] px-4 md:px-6 bg-[#AEA3CA] text-text-dark border border-[#D1D1E9] rounded-xl text-sm md:text-[14px] font-medium hover:bg-[#9F95C0] transition-colors">
                        Server
                    </button>
                    <button data-filter="system" class="h-12 md:h-[50px] px-4 md:px-6 bg-[#AEA3CA] text-text-dark border border-[#D1D1E9] rounded-xl text-sm md:text-[14px] font-medium hover:bg-[#9F95C0] transition-colors">
                        System
                    </button>
                </div>
                ...
                <!-- Priority Dropdown -->
                <div class="relative">
                    <button id="priorityFilterBtn" class="h-12 md:h-[50px] px-4 md:px-6 bg-[#AEA3CA] text-text-dark border border-[#D1D1E9] rounded-xl text-sm md:text-[14px] font-medium flex items-center gap-2 hover:bg-[#9F95C0] transition-colors">
                        <span>Priority</span>
                        <i class="fas fa-chevron-down text-xs"></i>
                    </button>
                    
                    <!-- Dropdown Menu -->
                    <div id="priorityDropdown" class="absolute top-full right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 z-50 hidden">
                        <div class="py-2">
                            <button data-priority="all" class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
                                <div class="w-3 h-3 bg-gray-400 rounded-full"></div>
                                All Priorities
                            </button>
                            <button data-priority="critical" class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
                                <div class="w-3 h-3 bg-red-500 rounded-full animate-pulse"></div>
                                Critical
                            </button>
                            <button data-priority="urgent" class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
                                <div class="w-3 h-3 bg-red-500 rounded-full"></div>
                                Urgent
                            </button>
                            <button data-priority="high" class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
                                <div class="w-3 h-3 bg-orange-500 rounded-full"></div>
                                High
                            </button>
                            <button data-priority="medium" class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
                                <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
                                Medium
                            </button>
                            <button data-priority="low" class="w-full px-4 py-3 text-left text-sm hover:bg-gray-50 transition-colors flex items-center gap-2">
    ...
    <div class="bg-gradient-to-r from-[#3D3C5E] to-[#48466B] rounded-2xl shadow-sm border border-[#AEA3CA] overflow-hidden mb-8">
        <!-- Notifications List -->
        <div class="p-4 md:p-6 space-y-3 md:space-y-4 max-h-[500px] overflow-y-auto custom-scrollbar">
            <!-- Notification 1 - Server Alert -->
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="critical" data-type="server">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <div class="flex items-center gap-2">
                                <h3 class="text-base md:text-lg font-bold text-white">Server SRV-ALPHA-01 Critical Alert</h3>
                        ...
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Memory usage exceeds 95% • Project Alpha • Ticket #2341</p>
                        <div class="flex items-center gap-2">
            ...
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="urgent" data-type="system">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <div class="flex items-center gap-2">
                                <h3 class="text-base md:text-lg font-bold text-white">Database Connection Pool Exhausted</h3>
                                <div class="unread-indicator">
                        ...
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">DB-PROD-01 • Connection timeout • Ticket #2338</p>
                        <div class="flex items-center gap-2">
                            <div class="priority-badge px-3 py-1 bg-red-500/20 rounded-lg">
            ...
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="high" data-type="server">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Daily backup for SRV-BETA-02 • Storage quota exceeded</p>
                        <div class="flex items-center gap-2">
            ...
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="medium" data-type="system">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">5 pending security patches • Schedule maintenance window</p>
                        <div class="flex items-center gap-2">
            ...
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="low" data-type="system">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
                            <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Switch SW-01 • Port 24 • Increased response time 200ms</p>
                        <div class="flex items-center gap-2">
            ...
            <div class="notification-item bg-white/10 rounded-xl p-4 md:p-5 hover:bg-white/15 transition-colors" data-priority="high" data-type="server">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm md:text-[14px] text-white/80 mb-3">Ticket #2342 • Load balancer configuration • Project Gamma</p>
                        <div class="flex items-center gap-2">
                            <div class="priority-badge px-3 py-1 bg-orange-500/20 rounded-lg">
                                <span class="text-xs font-bold text-orange-300">High</span>
                            </div>
        ...
        <div id="emptyState" class="hidden p-8 md:p-12 text-center">
            <div class="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 bg-white/10 rounded-full flex items-center justify-center">
            ...
            <p class="text-white/60 max-w-md mx-auto">
                All systems are running smoothly. You'll receive alerts for server issues, system updates, and assigned tickets.
            </p>
        </div>
    </div>
