...
<?= $this->section('title') ?>Assigned Design Requests - UI/UX Support Dashboard<?= $this->endSection() ?>
...
<div class="mt-4 md:mt-[77px] p-4 md:p-[30px] relative z-10">
    ...
    <div class="mb-6 md:mb-[25px] relative">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex-1">
                <h1 class="text-2xl md:text-[32px] font-semibold mb-1 md:mb-[5px] text-text-dark">Assigned Design
                    Requests</h1>
                <p class="text-sm md:text-[15px] font-light text-[#666]">Review and manage design requests assigned to
                    UI/UX department</p>
            </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8">
        ...
        <div class="bg-white rounded-xl p-3 md:p-5 shadow-sm border border-gray-200">
            <div class="flex items-center gap-2 md:gap-3">
                ...
                <div>
                    <p class="text-gray-600 text-xs md:text-sm">In Design</p>
                    <p class="text-xl md:text-2xl font-bold text-gray-800">6</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-3 md:p-5 shadow-sm border border-gray-200">
            <div class="flex items-center gap-2 md:gap-3">
                ...
                <div>
                    <p class="text-gray-600 text-xs md:text-sm">Completed Today</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6 md:mb-8">
        ...
        <div class="p-4 md:p-6 border-b border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <h2 class="text-lg md:text-[20px] font-semibold text-gray-800">UI/UX Design Requests</h2>
                ...
                <tbody id="ticketsTable" class="divide-y divide-gray-200">
                    ...
                    $assigned_tickets = [
                        [
                            'id' => '#DR10421',
                            'id_num' => 'DR10421',
                            'subject' => 'Redesign login page for better UX',
                        ...
                        [
                            'id' => '#DR10422',
                            'id_num' => 'DR10422',
                            'subject' => 'Mobile responsive dashboard layout',
                            'project' => 'Project Alpha',
                            'priority' => 'Low',
                            'priority_value' => 1,
                        ...
                        [
                            'id' => '#DR10423',
                            'id_num' => 'DR10423',
                            'subject' => 'Fix color contrast accessibility issues',
                        ...
                        [
                            'id' => '#DR10424',
                            'id_num' => 'DR10424',
                            'subject' => 'New icon set for navigation menu',
                            'project' => 'Project Beta',
                            'priority' => 'Low',
                            'priority_value' => 1,
                            'priorityColor' => 'bg-blue-100 text-blue-800',
                        ...
                        [
                            'id' => '#DR10425',
                            'id_num' => 'DR10425',
                            'subject' => 'Urgent: Fix mobile navigation bug',
                            'project' => 'Project Alpha',
                            'priority' => 'Urgent',
                            'priority_value' => 4,
                        ...
                        [
                            'id' => '#DR10426',
                            'id_num' => 'DR10426',
                            'subject' => 'Design new onboarding flow',
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
            <div class="flex items-center gap-3 md:gap-[15px] mb-4">
                <div class="w-10 h-10 md:w-12 md:h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <i class="fas fa-paint-brush text-blue-600 text-lg md:text-xl"></i>
                </div>
                <h3 class="text-lg md:text-[20px] font-semibold text-gray-800">UI/UX Design Guidelines</h3>
            </div>
            <p class="text-gray-600 text-sm md:text-base mb-4 md:mb-6">
                As a UI/UX designer, follow these design best practices:
            </p>
            <ol class="text-gray-600 text-sm md:text-base space-y-2 list-decimal pl-5">
                <li>Follow established design system and style guide</li>
                ...
                <li>Update request status after each design phase</li>
        ...
        <div class="bg-gradient-to-r from-secondary to-[#8A84C6] rounded-xl p-4 md:p-6 text-white">
            ...
            <p class="text-white/80 text-sm md:text-base mb-4 md:mb-6">
                Common tasks for UI/UX team
            </p>

            <div class="flex flex-col sm:flex-row gap-3">
                <a href="<?= base_url('department/ui-ux-support/ticket_detail/DR10425') ?>"
...
<script>
            ...
            row.innerHTML = `
                ...
                <td class="py-3 px-3 md:py-4 md:px-6">
                    <div class="flex items-center gap-2">
                        <a href="<?= base_url('department/ui-ux-support/ticket_detail/') ?>${ticket.id_num}" 
                        ...
                        <a href="<?= base_url('department/ui-ux-support/ticket_summary/') ?>${ticket.id_num}" 
            ...
            row.innerHTML = `
                <td colspan="7" class="py-8 px-4 md:px-6 text-center text-gray-500">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-base md:text-lg font-medium text-gray-400 mb-1">No design requests found</p>
    ...
    function generateReport() {
        ...
        setTimeout(() => {
            ...
            showToast('Design report generated successfully!', 'success');
        }, 1500);
    }
