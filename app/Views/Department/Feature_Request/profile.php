...
<?= $this->section('title') ?>Profile - Feature Request Department<?= $this->endSection() ?>
...
<div class="mt-[77px] p-[30px] relative z-10">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-[32px] font-semibold mb-2 text-text-dark">Feature Request Profile</h1>
                <p class="text-[15px] font-light text-[#666]">Manage your Feature Request account</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-2">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-6 mb-8">
                    ...
                    <!-- Product Analyst Info -->
                    <div class="flex-1">
                        <div class="flex flex-wrap items-center gap-3 mb-3">
                            <h2 class="text-2xl font-bold text-gray-800">Product Analyst</h2>
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-gray-700">analyst@featurerequest.com</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <i class="fas fa-id-badge text-gray-400"></i>
                                <span class="text-gray-700">ID: FR-2025-001</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <i class="fas fa-calendar-alt text-gray-400"></i>
                                <span class="text-gray-700">Joined: March 10, 2025</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <span class="text-gray-800">Sarah Johnson</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <span class="text-gray-800">User Experience Analysis</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <span class="text-gray-800">analyst@featurerequest.com</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <span class="text-gray-800">Senior Product Analyst</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <span class="text-gray-800">08:30 - 17:30 (Mon-Fri)</span>
                            </div>
                        </div>

                        <div>
                            <label class="block text-gray-600 text-sm mb-1">Focus Area</label>
                            <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <span class="text-gray-800">Mobile Applications</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">User Research</span>
                        <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">Market Analysis</span>
                        <span class="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">Data Analytics</span>
                        <span class="px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm">Competitive Analysis</span>
                        <span class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">Wireframing</span>
                        <span class="px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm">Product
                            Strategy</span>
                        <span class="px-3 py-1 bg-pink-100 text-pink-800 rounded-full text-sm">Stakeholder Mgmt</span>
                        <span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm">Agile Methodology</span>
                    </div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-br from-secondary to-[#8A84C6] rounded-2xl p-6 text-white">
                <h3 class="text-lg font-semibold mb-4">Analysis Performance</h3>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-white/80 text-sm">Features Analyzed</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-white/80 text-sm">Approved Features</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-white/80 text-sm">Avg. Analysis Time</p>
                                <p class="text-2xl font-bold">3.5d</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600" id="lastLoginTime">Today, 08:45 AM</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600">March 10, 2025</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div class="space-y-3">
                    <div class="p-3 bg-blue-50 rounded-lg cursor-pointer hover:bg-blue-100">
                        <p class="text-sm font-medium text-gray-800">Dark Mode Implementation</p>
                        <p class="text-xs text-gray-600">User dashboard • High Priority</p>
                    </div>

                    <div class="p-3 bg-green-50 rounded-lg cursor-pointer hover:bg-green-100">
                        <p class="text-sm font-medium text-gray-800">Advanced Analytics</p>
                        <p class="text-xs text-gray-600">Reporting module • Medium Priority</p>
                    </div>

                    <div class="p-3 bg-yellow-50 rounded-lg cursor-pointer hover:bg-yellow-100">
                        <p class="text-sm font-medium text-gray-800">Mobile App Features</p>
                        <p class="text-xs text-gray-600">Push notifications • Low Priority</p>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div class="bg-gray-50 rounded-xl p-4 text-center">
                            <p class="text-gray-600 text-sm mb-2">Requests Analyzed</p>
                        ...
                        <div class="bg-blue-50 rounded-xl p-4 text-center">
                            <p class="text-blue-600 text-sm mb-2">Avg. Analysis Time</p>
                            <p class="text-3xl font-bold text-blue-700">3.5d</p>
                            <p class="text-xs text-green-600 mt-1">
                                <i class="fas fa-arrow-down mr-1"></i>0.5d faster
                            </p>
                        </div>

                        <div class="bg-yellow-50 rounded-xl p-4 text-center">
                            <p class="text-yellow-600 text-sm mb-2">Approval Rate</p>
                            <p class="text-3xl font-bold text-yellow-700">68%</p>
                            <p class="text-xs text-green-600 mt-1">
                        ...
                        <div class="bg-green-50 rounded-xl p-4 text-center">
                            <p class="text-green-600 text-sm mb-2">Stakeholder Sat.</p>
                    ...
                    <div class="space-y-4">
                        <div>
                            <div class="flex justify-between text-sm mb-2">
                                <span class="text-gray-700 font-medium">Requirement Accuracy</span>
                        ...
                        <div>
                            <div class="flex justify-between text-sm mb-2">
                                <span class="text-gray-700 font-medium">Timeliness</span>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Recent analyses click
        document.querySelectorAll('.p-3.rounded-lg').forEach(analysis => {
            analysis.addEventListener('click', function () {
                ...
                showToast(`Analysis: ${title} - ${description}`, 'info');
            });
        });

        // View all analyses button
        const viewAllBtn = document.querySelector('button:contains("View All Analyses")');
        if (viewAllBtn) {
            viewAllBtn.addEventListener('click', function () {
                showToast('Opening all analyses...', 'info');
                setTimeout(() => {
                    window.location.href = '<?= base_url('department/feature-request/assigned_tickets') ?>';
                }, 1000);
            });
        }
    });
        ...
        modal.innerHTML = `
            <div class="bg-white rounded-2xl w-full max-w-md animate-fadeInUp">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h3 class="text-xl font-semibold text-gray-800">Edit Analyst Profile</h3>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" value="Sarah Johnson" class="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-secondary">
                        </div>
                        
                        <div>
                            <label class="block text-gray-600 text-sm mb-2">Email Address</label>
                            <input type="email" value="analyst@featurerequest.com" class="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-secondary">
                        </div>
                        ...
                        <div>
                            <label class="block text-gray-600 text-sm mb-2">Focus Area</label>
                            <select class="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-secondary">
    ...
    function saveProfileChanges() {
        ...
        setTimeout(() => {
            ...
            showToast('Analyst profile updated successfully!', 'success');
