...
<body class="bg-light-bg min-h-screen flex justify-center items-center overflow-hidden relative font-roboto px-4">
    ...
    <div class="absolute w-full h-full top-0 left-0 z-1">
        <div
            class="w-[40vw] h-[40vw] absolute -right-[10%] -bottom-[10%] rotate-[149deg] bg-gradient-to-r from-[rgba(26,35,126,0.3)] via-[#c5cae9] to-[#7986cb] blur-[60px] md:blur-80 opacity-80">
        </div>
        <div
            class="w-[35vw] h-[25vw] absolute -left-[5%] top-[10%] rotate-[8deg] bg-gradient-to-r from-[rgba(26,35,126,0.3)] via-[#c5cae9] to-[#7986cb] blur-[60px] md:blur-80 opacity-70">
        </div>
    </div>
    ...
    <div class="relative z-2 w-full max-w-[400px] md:max-w-[450px] p-4 md:p-5 flex flex-col items-center">
        ...
        <div class="flex items-center mb-6 md:mb-[30px]">
            ...
            <div class="text-[#283593] text-2xl md:text-[36px] font-bold ml-3 md:ml-[15px]">
                NEXUS Admin
            </div>
        </div>
        ...
        <div
            ...
            <div class="mb-4 text-center">
                <div class="inline-flex items-center bg-secondary/50 rounded-full px-4 py-2">
                    ...
                    <span class="text-white text-sm font-bold">Administrator Access</span>
                </div>
            </div>
            ...
            <form id="loginForm" action="<?= base_url('process_login') ?>" method="POST">
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full h-12 md:h-[45px] bg-secondary hover:bg-[#3949ab] text-white text-sm md:text-[16px] font-extrabold rounded md:rounded-[6px] border-none cursor-pointer transition-all duration-300 my-4 md:my-[20px] hover:-translate-y-[2px] hover:shadow-lg">
        ...
        <!-- Footer -->
        <div class="mt-4 text-center text-[#283593] text-xs md:text-[12px]">
            <p>© 2024 NEXUS Arch System. Admin Portal v1.0</p>
        </div>
    </div>
