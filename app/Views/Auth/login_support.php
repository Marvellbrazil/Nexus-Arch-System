...
<head>
    <meta charset="UTF-8">
    <title>NEXUS - Support Login</title>
...
<body class="bg-light-bg min-h-screen flex justify-center items-center overflow-hidden relative font-roboto px-4">
    ...
    <div class="absolute w-full h-full top-0 left-0 z-1">
        <div
            class="w-[40vw] h-[40vw] absolute -right-[10%] -bottom-[10%] rotate-[149deg] bg-gradient-to-r from-[rgba(0,105,92,0.3)] via-[#b2dfdb] to-[#80cbc4] blur-[60px] md:blur-80 opacity-80">
        </div>
        <div
            class="w-[35vw] h-[25vw] absolute -left-[5%] top-[10%] rotate-[8deg] bg-gradient-to-r from-[rgba(0,105,92,0.3)] via-[#b2dfdb] to-[#80cbc4] blur-[60px] md:blur-80 opacity-70">
        </div>
    </div>
    ...
    <div class="relative z-2 w-full max-w-[400px] md:max-w-[450px] p-4 md:p-5 flex flex-col items-center">
        ...
        <div class="flex items-center mb-6 md:mb-[30px]">
            <div
                class="w-12 h-12 md:w-[60px] md:h-[60px] rounded-lg md:rounded-[10px] bg-primary flex items-center justify-center text-white font-bold text-lg md:text-[24px]">
                <i class="fas fa-headset"></i>
            </div>
            <div class="text-[#00897b] text-2xl md:text-[36px] font-bold ml-3 md:ml-[15px]">
                NEXUS Support
            </div>
        </div>
        ...
        <div
            ...
            <div class="mb-4 text-center">
                <div class="inline-flex items-center bg-secondary/50 rounded-full px-4 py-2">
                    ...
                    <span class="text-white text-sm font-bold">Support Team Access</span>
                </div>
            </div>
            ...
            <form id="loginForm" action="<?= base_url('process_login') ?>" method="POST">
                ...
                <input type="hidden" name="login_type" value="support">
                ...
                <div class="mb-4 md:mb-[20px] w-full">
                    <label for="password"
                        class="block text-text-light text-xs md:text-[14px] font-bold mb-2 md:mb-[8px]">
                        Password
                    </label>
                    <div class="relative">
                        <div class="absolute left-4 top-1/2 transform -translate-y-1/2 text-text-light/70">
                ...
                <div class="flex items-center my-4 md:my-[20px]">
                    ...
                    <span
                        class="text-white text-xs md:text-[14px] font-bold ml-2 md:ml-[10px] cursor-pointer select-none"
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full h-12 md:h-[45px] bg-secondary hover:bg-[#00796b] text-white text-sm md:text-[16px] font-extrabold rounded md:rounded-[6px] border-none cursor-pointer transition-all duration-300 my-4 md:my-[20px] hover:-translate-y-[2px] hover:shadow-lg">
                    <i class="fas fa-sign-in-alt mr-2"></i>Login as Support
                </button>
                ...
                <div class="text-center mt-4">
                    ...
                    <div class="flex justify-center space-x-3">
                        ...
                        <a href="<?= base_url('department/login') ?>" class="text-text-light hover:text-accent text-xs">
        ...
        <!-- Footer -->
        <div class="mt-4 text-center text-[#00897b] text-xs md:text-[12px]">
            <p>© 2024 NEXUS Arch System. Support Portal v1.0</p>
        </div>
    </div>
