...
$username = $session->get('username') ?? $session->get('name') ?? $session->get('user') ?? 'Technical Support';

$notification_count = 3;
$notifications = [
    ['id' => 1, 'title' => 'New support ticket', 'message' => 'User reported login issue', 'time' => '2 hours ago', 'read' => false, 'type' => 'support'],
    ['id' => 2, 'title' => 'Issue resolved', 'message' => 'VPN connectivity issue resolved', 'time' => '4 hours ago', 'read' => false, 'type' => 'resolved'],
    ['id' => 3, 'title' => 'System maintenance', 'message' => 'Scheduled maintenance completed', 'time' => '1 day ago', 'read' => true, 'type' => 'maintenance'],
];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?= esc($title ?? 'Technical Support Dashboard - NEXUS') ?></title>
...
<body class="bg-light-bg min-h-screen relative overflow-x-hidden font-roboto">
    ...
    <header class="liquid-glass-navbar">
        ...
        <div class="desktop-layout">
            ...
            <div class="hidden md:flex items-center gap-3 navbar-left">
                <a href="<?= base_url('department/technical-support/dashboard') ?>"
                    ...
                    <div class="text-primary text-base md:text-lg font-bold whitespace-nowrap">Technical Support</div>
            ...
            <div class="desktop-nav-container">
                <a href="<?= base_url('department/technical-support/dashboard') ?>"
                    class="nav-glass-item <?= current_url() == base_url('department/technical-support/dashboard') ? 'active' : '' ?>">
                    ...
                    <div id="notificationDropdown"
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                <h3 class="font-bold text-sm md:text-base">Technical Support Notifications</h3>
                                <span
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="flex gap-3">
                                            <div class="flex-shrink-0">
                                                <?php if ($notification['type'] == 'support'): ?>
                                                    <div
                        ...
                        <div class="p-3 border-t border-gray-200 bg-gray-50">
                            <a href="<?= base_url('department/technical-support/notifications') ?>"
                ...
                <a href="<?= base_url('department/technical-support/profile') ?>"
        ...
        <div class="mobile-navbar-right">
            ...
            <div class="mobile-profile-section">
                ...
                <a href="<?= base_url('department/technical-support/profile') ?>" class="no-underline">
                    <div
    ...
    <div id="mobileNav"
        ...
        <div class="mobile-glass-menu animate-fade-in">
            ...
            <a href="<?= base_url('department/technical-support/profile') ?>"
                ...
                <div>
                    <div class="text-primary font-bold">Technical Support Agent</div>
                    <div class="text-primary/70 text-xs">Technical Support Department</div>
                </div>
            </a>
            ...
            <div class="p-3">
                <a href="<?= base_url('department/technical-support/dashboard') ?>"
                    class="mobile-nav-item <?= current_url() == base_url('department/technical-support/dashboard') ? 'active' : 'text-primary' ?>">
                ...
                <a href="<?= base_url('department/technical-support/logout') ?>"
    ...
    <footer class="bg-footer-bg h-12 md:h-[60px] w-full flex items-center px-4 md:px-6 mt-8">
        <div class="text-text-dark text-xs md:text-sm font-normal">
            Technical Support Dashboard • Copyright © <?= date('Y') ?> Nexus Arch System. All Rights Reserved.
        </div>
    </footer>
