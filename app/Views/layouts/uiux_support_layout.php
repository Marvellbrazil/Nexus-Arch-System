...
$username = $session->get('username') ?? $session->get('name') ?? $session->get('user') ?? 'UI/UX Support';

$notification_count = 3;
$notifications = [
    ['id' => 1, 'title' => 'New design review', 'message' => 'Homepage redesign ready for review', 'time' => '1 hour ago', 'read' => false, 'type' => 'design'],
    ['id' => 2, 'title' => 'User feedback', 'message' => 'User testing feedback received', 'time' => '3 hours ago', 'read' => false, 'type' => 'feedback'],
    ['id' => 3, 'title' => 'Prototype updated', 'message' => 'Mobile app prototype v2.0 completed', 'time' => '1 day ago', 'read' => true, 'type' => 'prototype'],
];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?= esc($title ?? 'UI/UX Support Dashboard - NEXUS') ?></title>
...
<body class="bg-light-bg min-h-screen relative overflow-x-hidden font-roboto">
    ...
    <header class="liquid-glass-navbar">
        ...
        <div class="mobile-navbar-left">
            ...
            <!-- Logo (Mobile) -->
            <a href="<?= base_url('department/uiux-support/dashboard') ?>" class="flex items-center gap-3 no-underline">
        ...
        <div class="desktop-layout">
            ...
            <div class="hidden md:flex items-center gap-3 navbar-left">
                <a href="<?= base_url('department/uiux-support/dashboard') ?>"
                    class="flex items-center gap-3 no-underline">
                    <div class="w-8 h-8 logo-glass rounded-xl flex items-center justify-center">
                        <i class="fas fa-palette text-white text-sm"></i>
                    </div>
                    <div class="text-primary text-base md:text-lg font-bold whitespace-nowrap">UI/UX Support</div>
            ...
            <div class="desktop-nav-container">
                <a href="<?= base_url('department/uiux-support/dashboard') ?>"
                    class="nav-glass-item <?= current_url() == base_url('department/uiux-support/dashboard') ? 'active' : '' ?>">
                    <i class="fas fa-tachometer-alt mr-2 text-sm"></i>
                    Dashboard
                </a>

                <a href="<?= base_url('department/uiux-support/design_tasks') ?>"
                    class="nav-glass-item <?= strpos(current_url(), 'design_tasks') !== false ? 'active' : '' ?>">
                    ...
                    <div id="notificationDropdown"
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                <h3 class="font-bold text-sm md:text-base">UI/UX Support Notifications</h3>
                                <span
                        ...
                        <div class="p-3 border-t border-gray-200 bg-gray-50">
                            <a href="<?= base_url('department/uiux-support/notifications') ?>"
                ...
                <a href="<?= base_url('department/uiux-support/profile') ?>"
        ...
        <div class="mobile-navbar-right">
            ...
            <div class="relative">
                ...
                <div id="mobileNotificationDropdown"
                    class="notification-dropdown absolute right-0 mt-3 w-72 bg-white rounded-2xl shadow-xl border border-gray-200 z-50 overflow-hidden">
                    <div
                        class="p-4 border-b border-gray-200 bg-gradient-to-r from-secondary to-[#8A84C6] text-white rounded-t-2xl">
                        <div class="flex justify-between items-center">
                            <h3 class="font-bold text-sm">Notifications</h3>
                            <span class="text-xs bg-white/20 px-2 py-1 rounded-full"><?= $notification_count ?>
                                new</span>
                        </div>
                    </div>
                    ...
                    <div class="p-3 border-t border-gray-200 bg-gray-50">
                        <a href="<?= base_url('department/uiux-support/notifications') ?>"
                            class="block text-center text-secondary font-medium hover:text-[#665C9E] transition-colors text-xs">
                            View All
                        </a>
                    </div>
                </div>
            ...
            <div class="mobile-profile-section">
                ...
                <a href="<?= base_url('department/uiux-support/profile') ?>" class="no-underline">
                    <div
    ...
    <div id="mobileNav"
        ...
        <div class="mobile-glass-menu animate-fade-in">
            ...
            <a href="<?= base_url('department/uiux-support/profile') ?>"
                ...
                <div>
                    <div class="text-primary font-bold">UI/UX Support Designer</div>
                    <div class="text-primary/70 text-xs">Design & User Experience Department</div>
                </div>
            </a>
            ...
            <div class="p-3">
                <a href="<?= base_url('department/uiux-support/dashboard') ?>"
                    class="mobile-nav-item <?= current_url() == base_url('department/uiux-support/dashboard') ? 'active' : 'text-primary' ?>">
                    <i class="fas fa-tachometer-alt text-secondary"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <a href="<?= base_url('department/uiux-support/design_tasks') ?>"
                    class="mobile-nav-item <?= strpos(current_url(), 'design_tasks') !== false ? 'active' : 'text-primary' ?>">
                    <i class="fas fa-paint-brush text-secondary"></i>
                    <span class="font-medium">Design Tasks</span>
                </a>
                ...
                <a href="<?= base_url('department/uiux-support/notifications') ?>" class="mobile-nav-item text-primary">
                    <i class="fas fa-bell text-secondary"></i>
                    <span class="font-medium">Notifications</span>
                </a>

                <a href="<?= base_url('department/uiux-support/logout') ?>"
    ...
    <footer class="bg-footer-bg h-12 md:h-[60px] w-full flex items-center px-4 md:px-6 mt-8">
        <div class="text-text-dark text-xs md:text-sm font-normal">
            UI/UX Support Dashboard • Copyright © <?= date('Y') ?> Nexus Arch System. All Rights Reserved.
        </div>
    </footer>
